      ...
      const allSalles = salles
        .map((salle) => {
          ...
          <tr>
              ...
              <td>${type}</td>
              <td>${bloc.nom}</td>
              <td><div class="qr" id="${salleID}"></div></td>
              <td>
              <button type="button" class="btnu btn btn-outline-success" data-blocid="${bloc._id}" data-bloc="${bloc.nom}" data-type="${type}" data-nom="${nom}" data-id="${salleID}">
              <i class="fas fa-pen"></i>
              </button>
              <button type="button" class="btnd btn btn-outline-danger" data-id="${salleID}">
